...
public class Board {
    ...
    public void DoMovePawnsPhase() throws GameException {
        ...
        Strategy strategy = actingPlayer.GetStrategy();
        Pawn[] available = GetAvailablePawns(actingPlayer.GetPlayerId());

        Pawn pawn = strategy.ChoosePawn(available, pawns, valueRolled);
    ...
    public void SetPlayerName(int index, String value) {
    ...
    public void SetPlayerType(int index, PTYPE type)
    {
        ...
        switch(type)
        {
            ...
            case MOVE_BACK: strategy = new MoveBackStrategy(player); break;
        }
        
        player.SetStrategy(strategy);
    }
    
    public PTYPE GetPlayerType(int index)
    {
        Strategy strategy = players[index].GetStrategy();
